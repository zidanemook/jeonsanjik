...
for(const card of cards.values())if(/^(?:(?:study|summary)-hist-20260910-|summary-hist-20260911-|lecture-hist-20260911-|summary-hist-20260912-|(?:heritage|daily)-hist-20260912-)/.test(card.id))assert(ids.has(card.id),'Summary question excluded from scope: '+card.id);
...
const LECTURE_0708=/^(?:lecture-hist-20260911-|heritage-hist-20260912-)/;
...
const newIds=Object.keys(catalog.questions).filter(id=>LECTURE_0708.test(id));assert.equal(newIds.length,66);assert.deepEqual(lectures[2].ids,newIds);
