...
globalThis.QUIZ_OPTIONS={
  ...
  "grammar-agreement-none": {
    ...
    "choices": [
      ...
      "None of the students is here.만 가능하고 are는 모든 용례에서 틀리다.",
  ...
  "study-hist-20260910-06": {
    "choices": [
      ...
      "돌로 만든 농기구만 사용되고 철제 무기는 아직 등장하지 않았다."
    ],
    "correctIndex": 1
  },
  ...
  "study-hist-20260910-14": {
    "choices": [
      ...
      "마가·우가·저가·구가가 사출도를 나누어 다스리고 영고를 열었다.",
  ...
  "study-hist-20260910-40": {
    "choices": [
      ...
      "고구려의 옛 영토를 모두 회복했다.",
      "백제와 고구려 유민은 당을 몰아내는 과정에 참여하지 않았다."
    ],
    "correctIndex": 1
  },
  ...
  "summary-hist-20260910-030": {
    "choices": [
      ...
      "연의 공격 직후 왕검성이 함락되어 위만 조선이 성립하지 못했다",
  ...
  "summary-hist-20260910-040": {
    "choices": [
      ...
      "부여는 천군·소도, 고구려는 신지·읍차가 정치를 담당했다",
  ...
  "summary-hist-20260910-059": {
    "choices": [
      ...
      "수 양제·안시성은 645년, 당 태종·살수는 612년이다",
  ...
  "summary-hist-20260910-061": {
    "choices": [
      ...
      "수와의 전쟁에서 패배한 즉시 612년에 고구려가 멸망했다"
    ],
    "correctIndex": 0
  },
  ...
  "summary-hist-20260910-063": {
    "choices": [
      ...
      "금관가야—내륙 농업·제철 / 대가야—해상 교통·낙랑과 왜를 잇는 교역",
  ...
  "summary-hist-20260910-064": {
    "choices": [
      ...
      "전기 대가야—고령·해상 교통 → 후기 금관가야—김해·내륙 농업",
  ...
  "summary-hist-20260910-095": {
    "choices": [
      ...
      "당의 지배를 그대로 인정해 한반도 전역을 직접 통치했다",
  ...
  "summary-hist-20260910-107": {
    "choices": [
      "처음부터 김씨만 왕위를 계승하다가 내물 때 박씨로 바뀌었다",
  ...
  "summary-hist-20260910-110": {
    "choices": [
      ...
      "처음부터 끝까지 연합을 유지하여 성왕이 대가야 병합을 지휘했다",
  ...
  "summary-hist-20260910-117": {
    "choices": [
      ...
      "집사부는 지방군 10정을 지휘하고 시중은 주자감을 관할했다",
  ...
  "summary-hist-20260910-169": {
    "choices": [
      ...
      "견훤이 후백제를 세운 직후 신라에 항복했고, 경순왕은 발해로 갔다",
  ...
  "summary-hist-20260910-171": {
    "choices": [
      "926년 발해 멸망→935년 신라 항복→936년 후삼국 통일",
      "935년 발해 멸망→926년 신라 항복→936년 후삼국 통일",
      "926년 신라 항복→935년 발해 멸망→936년 후삼국 통일",
      "936년 발해 멸망→935년 신라 항복→926년 후삼국 통일"
    ],
    "correctIndex": 0
  },
  ...
  "summary-hist-20260911-005": {
    "choices": [
      ...
      "건원 연호를 쓰고 전진에 사신을 보내 불교를 받아들였다",
  ...
  "summary-hist-20260911-009": {
    "choices": [
      ...
      "왕 아래 마가·우가·저가·구가가 있고 사출도를 나누어 다스렸다",
  ...
  "lecture-hist-20260911-014": {
    "choices": [
      ...
      "한강 유역을 확보한 뒤 당항성을 통해 처음으로 중국과 직접 교역했다",
  ...
  "lecture-hist-20260911-019": {
    "choices": [
      "왕족 부여씨와 8성 귀족이 지배층이었고, 진씨·해씨가 왕비족이었다",
  ...
  "lecture-hist-20260911-033": {
    "choices": [
      "세속 5계를 지었고, 진흥왕 때 당에 가서 군사 동맹을 맺었다",
