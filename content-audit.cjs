...
// LONGEST_LIMIT: 11강 103문제 추가 뒤 실측 15.8%(124/787)를 상한으로 다시 조인 래칫(이전 21.2%, 그 전 27.8%). 문제를 더하다 이 값을 넘기면 실패한다.
// MARGIN: 실측 최대 초과폭 7자에 여유 5자를 더한 값. 후보 문항은 모두 통과하지만 24자씩 튀던 예전 문항은 걸린다.
const LONGEST_LIMIT=0.158,MARGIN=12,VERBATIM_OFFICIAL=/^(?:hanneung|gichul)-/;
