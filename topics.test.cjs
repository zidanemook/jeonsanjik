...
const order=['prehistory','gojoseon','goguryeo-gaya','baekje-silla','unified-silla','balhae','later-three','compare','goryeo','joseon-early','joseon-late','opening','korean-empire','colonial','contemporary'];
