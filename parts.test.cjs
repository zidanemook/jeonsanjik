...
const counts={};
{
 ...
 for(const t of ['Day 1','Day 2','Day 3','Day 4','Day 5','Day 6','Day 7','문법 공식 훈련','논리 1장','논리 2장','논리 3장','논리 4장','논리 5장','논리 6장','독해 1장'])assert.ok(PARTS.units.some(u=>u.scope.topic===t),t+'에 파트가 있다');
