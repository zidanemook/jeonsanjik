...
(function(root){
 ...
 function judge(key,choices,wrongIndex,explanation,question){
  bank[verb(key)].variants.push({type:'choice',question:question||'다음 중 어법상 옳지 않은 문장을 고르세요.',choices,correctIndex:wrongIndex,explanation});
 }
 ...
 ['“그 코치는 새 선수들에게 규칙을 설명했다.”\nThe coach explained the rules ___ the new players.\n빠진 한 단어를 쓰세요.','to','explain은 설명하는 내용을 목적어로 두고 듣는 사람은 to로 연결한다. explained the new players the rules처럼 4형식으로 쓰지 않는다. introduce·suggest·announce도 같다.'],
 ['전치사가 빠졌습니다. “그 건축가는 의뢰인에게 새 설계를 제안했다.”가 되도록 대괄호 부분을 세 단어로 고쳐 쓰세요.\nThe architect suggested a new design [the client].','to the client','suggest도 제안하는 내용을 목적어로 두고 듣는 사람은 to로 연결한다. suggested the client a new design이라는 4형식은 쓰지 않는다.'],
 ['“위원회는 어제 그 제안을 논의했다.”\nThe committee ___ the proposal yesterday.\ndiscuss의 과거형을 전치사 없이 한 단어로 쓰세요.','discussed','discuss는 목적어를 바로 받는 타동사다. 한국어의 “~에 대해” 때문에 discussed about을 붙이지 않는다.'],
 ['“그 배우는 조용히 방에 들어갔다.”\nThe actor ___ the room quietly.\nenter의 과거형을 전치사 없이 한 단어로 쓰세요.','entered','enter는 전치사 없이 목적어를 받는다. “방에”라는 한국어 때문에 entered into the room으로 쓰지 않는다. enter into는 계약이나 논의를 시작한다는 다른 뜻이다.'],
 ['“그는 지난봄에 대학 동창과 결혼했다.”\nHe ___ his college classmate last spring.\nmarry의 과거형을 전치사 없이 한 단어로 쓰세요.','married','marry는 목적어를 바로 받는 타동사라 married with라고 쓰지 않는다. 결혼한 상태를 말할 때만 be married to를 쓴다.'],
 ['“그 쌍둥이는 목소리까지 서로 닮았다.”\nThe twins closely ___ each other in voice.\nresemble을 현재형 한 단어로 쓰세요.','resemble','resemble은 목적어를 바로 받는 타동사라 resemble with나 resemble to를 붙이지 않는다. 주어 The twins가 복수이므로 resemble 그대로 쓴다.']]);
 ...
 judge('preposition',['The manager announced the new policy to every branch office.','Our team finally reached the summit shortly after the sunrise.','She discussed about the budget with two of her colleagues.','The tenants are still waiting for the landlord to reply.'],2,'discuss는 전치사 없이 목적어를 받는 타동사이므로 discussed the budget with her colleagues로 고친다. 첫 문장의 announce는 알리는 내용을 목적어로 두고 듣는 사람을 to로 연결했으므로 맞다. 둘째의 reach는 도착 지점을 바로 목적어로 받아 맞다. 넷째의 wait는 목적어를 바로 받지 못해 for가 있어야 하므로 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('preposition',['The clerk answered every question without checking his file.','He married with a violinist he met at the summer festival.','Nobody explained the new safety rules to the night shift crew.','The twins resemble each other in voice but not in height.'],1,'marry는 목적어를 바로 받는 타동사이므로 married a violinist로 고친다. 상태를 나타내는 be married to와 헷갈린 형태다. 첫 문장의 answer도 전치사 없이 목적어를 받아 맞다. 셋째의 explain은 듣는 사람을 to로 연결했으므로 맞다. 넷째의 resemble도 전치사 없이 목적어를 받는다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
 ...
 ['“그 편지는 몇 주 동안 서랍 속에 놓여 있었다.”\nThe letter ___ in the drawer for weeks.\nlie(놓여 있다)의 과거형을 한 단어로 쓰세요.','lay','“놓여 있다”는 목적어가 없는 자동사 lie이고 그 과거형은 lay다. 타동사 lay(놓다)의 과거형 laid와 형태가 다르다.'],
 ['“그 상자들은 개봉되지 않은 채 지하실에 놓여 있었다.”\nThe boxes have ___ unopened in the basement.\nlie의 과거분사를 한 단어로 쓰세요.','lain','자동사 lie의 활용은 lie-lay-lain이므로 현재완료는 have lain이다. have laid는 타동사 lay(놓다)의 현재완료다.'],
 ['“그 개는 난롯가에 누워 있다.”\nThe dog is ___ by the fireplace.\nlie(눕다)의 -ing형을 한 단어로 쓰세요.','lying','자동사 lie의 -ing형은 철자가 바뀌어 lying이 된다. laying은 타동사 lay(놓다)의 -ing형이다.'],
 ['“그들은 마침내 다락에서 잃어버린 지도를 찾았다.”\nThey finally ___ the missing map in the attic.\nfind의 과거형을 한 단어로 쓰세요.','found','find(찾다)의 과거형은 found다. 철자가 같은 found(설립하다)는 원형이고 그 과거형은 founded이므로, 문맥이 “찾았다”이면 founded로 쓰지 않는다.'],
 ['“그 학교는 1912년에 두 자매에 의해 설립되었다.”\nThe school ___ by two sisters in 1912.\nfound(설립하다)를 과거 수동태 두 단어로 쓰세요.','was founded','found(설립하다)는 found-founded-founded이므로 과거분사도 founded다. was found로 쓰면 “발견되었다”라는 다른 뜻이 된다.']]);
 ...
 judge('lookalike',['The dog has lain by the fireplace since early this morning.','She laid the tray on the small table beside the front window.','The gardener is laying new stones along the narrow path.','The old letters have laid in that drawer since the war ended.'],3,'편지는 스스로 놓여 있는 것이라 자동사 lie를 쓰고 그 과거분사는 lain이므로 have lain으로 고친다. laid는 타동사 lay(놓다)의 과거분사다. 첫 문장은 자동사 lie의 현재완료라 맞다. 둘째는 the tray라는 목적어가 있어 laid가 맞다. 셋째도 new stones라는 목적어가 있어 laying이 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('lookalike',['They found the missing map under a pile of old newspapers.','She lay the sleeping baby in the crib and left the room.','The twins are lying on the grass and watching the clouds.','He laid his coat over the back of the chair and sat down.'],1,'아기를 눕히는 동작에는 목적어가 있으므로 타동사 lay를 쓰고 과거형은 laid다. She laid the sleeping baby로 고친다. lay는 자동사 lie의 과거형이기도 해서 형태가 겹치지만 목적어가 있으면 laid다. 첫 문장은 find(찾다)의 과거형 found라 맞다. 셋째는 자동사 lie의 -ing형 lying, 넷째는 타동사 lay의 과거형 laid라 맞다. 넷째는 his coat라는 목적어가 있어 laid가 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
 ...
 ['“그의 새 소설은 아주 술술 읽힌다.”\nHis new novel ___ very smoothly.\nread를 현재형 능동태 한 단어로 쓰세요.','reads','read는 주어가 글일 때 능동형 그대로 “잘 읽힌다”라는 뜻을 나타낸다. 읽히는 대상이라는 이유로 is read로 바꾸지 않는다. 주어가 3인칭 단수라 reads다.'],
 ['“이 셔츠는 찬물에서도 세탁이 잘된다.”\nThis shirt ___ well in cold water.\nwash를 현재형 능동태 한 단어로 쓰세요.','washes','wash도 능동형 그대로 “세탁이 잘된다”라는 뜻을 나타낸다. is washed로 바꾸면 누가 빨아 준다는 다른 뜻이 된다.'],
 ['“오늘 아침 해는 5시 30분에 떴다.”\nThe sun ___ at five thirty this morning.\nrise의 과거형을 한 단어로 쓰세요.','rose','rise는 목적어 없이 스스로 오른다는 자동사라 rise-rose-risen으로 활용한다. was risen처럼 수동태로 쓰지 않는다.'],
 ['“그 요금은 시의회에 의해 두 번 인상되었다.”\nThe fees ___ twice by the city council.\nraise를 사용해 현재완료 수동태 세 단어로 쓰세요.','have been raised','raise는 목적어를 받는 타동사라 수동태가 가능하다. 요금은 인상되는 대상이므로 have been raised다. 뜻이 비슷해도 자동사 rise는 have been risen으로 쓸 수 없다.']]);
 ...
 judge('no-passive',['This detective novel reads well even on a crowded subway.','The temperature rose sharply during the second week of July.','The bus fares have been raised twice since last September.','The sun was risen behind the hills before we left the camp.'],3,'rise는 목적어가 없는 자동사라 수동태로 쓰지 않는다. had risen 또는 rose로 고친다. 첫 문장의 read는 능동형 그대로 “잘 읽힌다”라는 뜻이라 맞다. 둘째는 자동사 rise의 과거형이라 맞다. 셋째의 raise는 타동사라 수동태가 가능하므로 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('no-passive',['This cotton shirt washes well and dries in a couple of hours.','Her second album is selling faster than the first one did.','The council rose the parking fees again in early December.','The tide had risen well above the rocks before we noticed.'],2,'rise는 목적어를 받지 못하는 자동사다. the parking fees라는 목적어가 있으므로 타동사 raise를 써서 raised로 고친다. 첫 문장의 wash와 둘째의 sell은 능동형 그대로 “잘 세탁된다·잘 팔린다”라는 뜻이라 맞다. 넷째는 조수가 스스로 올랐다는 자동사 rise의 과거완료라 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
 ...
 ['“나는 복도에서 내 이름이 불리는 것을 들었다.”\nI heard my name ___ in the hallway.\ncall을 과거분사 한 단어로 쓰세요.','called','hear + 목적어 + 과거분사다. 이름은 불리는 쪽이므로 called를 쓴다. 이름이 스스로 부르는 것이 아니라서 calling은 맞지 않다.'],
 ['“나는 옆방에서 누가 피아노 치는 소리를 들었다.”\nI listened to someone ___ the piano next door.\nplay를 현재분사 한 단어로 쓰세요.','playing','listen to + 목적어 + 현재분사다. 피아노를 치는 쪽이 someone이므로 playing이다. 목적어가 동작을 하면 현재분사, 받으면 과거분사를 쓴다.'],
 ['“그녀는 오늘 아침 깨진 창문을 교체했다.”\nShe had the broken window ___ this morning.\nreplace를 과거분사 한 단어로 쓰세요.','replaced','have + 목적어 + 과거분사다. 창문은 교체되는 쪽이므로 replaced를 쓴다. 직접 갈아 끼운다는 뜻이 아니라 남을 시켜 그렇게 되게 한다는 뜻이다.'],
 ['“그 감독은 소음을 뚫고 자기 목소리가 들리게 했다.”\nThe director made his voice ___ over the noise.\nhear를 사용해 두 단어로 쓰세요.','be heard','make 뒤에는 원형부정사를 쓰고, 목적어가 동작을 받으면 그 원형 자리에 be + 과거분사를 넣는다. 목소리는 들리는 쪽이므로 be heard다.'],
 ['“우리는 그 결과가 금요일에 발표되기를 기대한다.”\nWe expect the results ___ on Friday.\nannounce를 사용해 수동형 to부정사 세 단어로 쓰세요.','to be announced','expect는 want와 같이 목적어 뒤에 to부정사를 쓴다. 결과는 발표되는 쪽이므로 to be announced이며, 원형 be announced로 쓰지 않는다.']]);
 ...
 judge('object-voice',['She had the cracked screen replaced at the shop last Monday.','I heard my name calling twice before I found the right desk.','We expect the results to be announced early on Friday morning.','The nurse kept the wound covered with a clean cotton bandage.'],1,'이름은 불리는 쪽이므로 과거분사를 써서 heard my name called로 고친다. 이름이 스스로 부르는 것이 아니라 calling은 맞지 않다. 첫 문장은 화면이 교체되는 쪽이라 have + 과거분사가 맞다. 셋째의 expect는 목적어 뒤에 to부정사를 쓰므로 맞다. 넷째는 상처가 덮이는 쪽이라 keep + 과거분사가 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('object-voice',['Please keep the back door locked while the alarm is switched off.','I listened to the rain falling on the metal roof for hours.','The teacher wanted the essays hand in by Thursday evening.','She had her passport photographs taken at the corner shop.'],2,'보고서는 제출되는 쪽이므로 wanted the essays handed in 또는 wanted the essays to be handed in으로 고친다. 원형 hand in은 want 뒤에 올 수 없다. 첫 문장의 keep + 과거분사와 넷째의 have + 과거분사는 목적어가 동작을 받는 경우라 맞다. 둘째는 비가 내리는 쪽이라 현재분사 falling이 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
 ...
 ['“그 도서관은 방문객이 사진 찍는 것을 허용한다.”\nThe library allows visitors ___ photographs.\ntake를 알맞은 형태로 바꿔 두 단어로 쓰세요.','to take','allow는 목적어 뒤에 to부정사를 쓴다. allows visitors taking처럼 -ing를 쓰지 않는다. encourage·advise·cause·force·persuade도 같은 짝이다.'],
 ['“그녀는 아버지를 설득해 낡은 차를 팔게 했다.”\nShe persuaded her father ___ the old car.\nsell을 알맞은 형태로 바꿔 두 단어로 쓰세요.','to sell','persuade도 목적어 뒤에 to부정사를 쓴다. persuaded her father selling이나 persuaded her father sell로 쓰지 않는다.'],
 ['“정전 때문에 승객들이 몇 시간을 기다리게 되었다.”\nThe blackout caused the passengers ___ for hours.\nwait를 알맞은 형태로 바꿔 두 단어로 쓰세요.','to wait','cause는 목적어 뒤에 to부정사를 쓴다. 뜻이 사역과 비슷해도 cause는 make와 달리 원형부정사를 쓰지 않는다.'],
 ['“선생님은 학생들이 사전을 쓰게 해 주었다.”\nThe teacher let the students ___ their dictionaries.\nuse를 알맞은 형태로 바꿔 한 단어로 쓰세요.','use','let은 목적어 뒤에 원형부정사를 쓴다. let the students to use로 쓰지 않는다. make·have도 같은 원형 자리를 쓴다.'],
 ['“나는 기술자에게 배선을 점검하게 했다.”\nI had the technician ___ the wiring.\ncheck를 알맞은 형태로 바꿔 한 단어로 쓰세요.','check','have는 목적어 뒤에 원형부정사를 쓴다. 점검하는 쪽이 기술자이므로 원형 check를 쓰고 to check로 바꾸지 않는다.'],
 ['“짙은 안개 때문에 우리는 활주로를 볼 수 없었다.”\nThe thick fog prevented us ___ the runway.\nsee를 사용해 두 단어로 쓰세요.','from seeing','prevent A from -ing로 “A가 ~하지 못하게 하다”를 나타낸다. keep·stop·discourage도 같은 짝이라 prevented us to see로 쓰지 않는다.']]);
 ...
 judge('object-form',['The counselor advised the freshmen to keep a weekly journal.','A sudden storm caused the ferry to leave two hours late.','Her parents let her to travel alone for the first time.','The new rule stops drivers from parking near the school gate.'],2,'let은 목적어 뒤에 원형부정사를 쓰므로 let her travel alone으로 고친다. 첫 문장의 advise와 둘째의 cause는 to부정사를 쓰는 동사라 맞다. 넷째의 stop은 A from -ing 짝이라 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('object-form',['The heavy snow kept the climbers from reaching the shelter.','Our manager had the intern rewrite the report before noon.','The coach persuaded him joining the relay team this season.','This app allows parents to set a daily limit on screen time.'],2,'persuade는 목적어 뒤에 to부정사를 쓰므로 persuaded him to join으로 고친다. 첫 문장의 keep은 A from -ing 짝이라 맞다. 둘째의 have는 원형부정사를 쓰므로 rewrite가 맞다. 넷째의 allow는 to부정사를 쓰므로 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
 ...
 ['대괄호 부분만 한 단어로 고쳐 쓰세요.\nThe kitchen smelled [strangely] all morning.','strange','smell은 주어의 상태를 설명하는 동사라 보어에 형용사 strange를 쓴다. 부엌이 냄새를 “이상하게 맡는다”는 뜻이 아니므로 부사 strangely는 맞지 않다.'],
 ['대괄호 부분만 한 단어로 고쳐 쓰세요.\nHer excuse sounded [reasonably] to everyone.','reasonable','sound 뒤의 보어는 주어 excuse를 설명하므로 형용사 reasonable을 쓴다. 부사 reasonably는 sound라는 동작을 꾸미게 되어 맞지 않다.'],
 ['“그는 발표 내내 초조해 보였다.”\nHe looked ___ throughout the presentation.\nnervous 또는 nervously 중 알맞은 것을 쓰세요.','nervous','look은 주어의 상태를 설명하는 동사라 형용사 nervous를 쓴다. looked nervously는 “초조하게 쳐다보았다”라는 다른 뜻이 된다.'],
 ['“그 담요는 놀랄 만큼 부드러운 느낌이 난다.”\nThis blanket feels surprisingly ___.\nsoft 또는 softly 중 알맞은 것을 쓰세요.','soft','feel 뒤의 보어는 주어 blanket을 설명하므로 형용사 soft다. surprisingly는 그 형용사를 꾸미는 부사라 그대로 둔다.'],
 ['“소식이 발표될 때까지 침착하게 계세요.”\nPlease stay ___ until the news is announced.\ncalm 또는 calmly 중 알맞은 것을 쓰세요.','calm','stay도 상태가 이어짐을 말하는 동사라 보어에 형용사 calm을 쓴다. stay calmly라고 쓰지 않는다.']]);
 ...
 judge('linking',['The old blanket still feels soft after so many trips to the lake.','The soup tasted saltily even after I added a cup of water.','His explanation sounded reasonable to almost everyone there.','The passengers remained seated until the seat belt sign went off.'],1,'taste는 주어의 상태를 설명하는 동사라 보어에 형용사를 쓴다. tasted salty로 고친다. 국물이 무엇을 맛보는 것이 아니므로 부사 saltily는 성립하지 않는다. 첫 문장의 feels soft와 셋째의 sounded reasonable도 형용사 보어라 맞다. 넷째는 승객이 앉혀진 상태라 remain 뒤에 과거분사 seated가 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('linking',['The whole house smelled of burnt toast for the entire morning.','Please stay calm until the rescue team reaches the second floor.','The tourists remained seating on the steps until the guide came.','That new brand of tea tastes bitter unless you add some honey.'],2,'관광객은 계단에 앉혀진 상태로 있는 것이므로 remained seated로 고친다. remain seating은 누군가를 앉히고 있다는 뜻이 되어 맞지 않다. 첫 문장의 smell of는 냄새의 출처를 밝히는 짝이라 맞다. 둘째의 stay calm과 넷째의 tastes bitter는 주어를 설명하는 형용사 보어라 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
 ...
 ['“동료들은 그녀를 팀에서 가장 신중한 사람으로 여긴다.”\nHer colleagues regard her ___ the most careful person here.\n빠진 한 단어를 쓰세요.','as','regard A as B로 “A를 B로 여기다”를 나타낸다. regard her to be로 바꾸지 않는다. think of A as B도 같은 짝이다.'],
 ['“지역 주민들은 그 다리를 옛 다리라고 부른다.”\nLocal residents refer to the bridge ___ the Old Crossing.\n빠진 한 단어를 쓰세요.','as','refer to A as B로 “A를 B라고 부르다”를 나타낸다. as를 by나 with로 바꾸지 않는다.'],
 ['“편집자는 그 기자를 자료를 지어낸 혐의로 비난했다.”\nThe editor accused the reporter ___ inventing the data.\n빠진 한 단어를 쓰세요.','of','accuse A of B에서 of 뒤에 동사가 오면 inventing처럼 -ing 형태가 된다. accused the reporter for inventing으로 쓰지 않는다.'],
 ['대괄호 부분만 한 단어로 고쳐 쓰세요.\nThey accused the supplier [for] raising the prices twice.','of','accuse는 of와 짝을 이루므로 accused the supplier of raising으로 고친다. for를 쓰는 것은 blame A for B다.'],
 ['대괄호 부분만 한 단어로 고쳐 쓰세요.\nMost readers think of her [to be] a careful critic.','as','think of A as B가 짝이므로 think of her as a careful critic으로 고친다. think of A to be라는 형태는 쓰지 않는다.']]);
 ...
 judge('prep-pair',['The neighbors accused the builder of ignoring the noise rules.','Everyone here refers to that narrow lane as the back road.','The board regarded her proposal to be far too expensive.','I have always thought of him as a patient and fair teacher.'],2,'regard는 as와 짝을 이루므로 regarded her proposal as far too expensive로 고친다. 첫 문장의 accuse A of B, 둘째의 refer to A as B, 넷째의 think of A as B는 모두 정해진 짝을 지켰으므로 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('prep-pair',['She accused her landlord for keeping the deposit too long.','Historians regard the treaty as the start of a long peace.','The manual refers to this switch as the emergency cutoff.','Few people think of that quiet town as a tourist destination.'],0,'accuse는 of와 짝을 이루므로 accused her landlord of keeping the deposit으로 고친다. for를 쓰는 것은 blame A for B다. 둘째의 regard A as B, 셋째의 refer to A as B, 넷째의 think of A as B는 모두 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
 ...
 ['“그가 그 파일을 어디에 두었는지 아세요?”\nDo you know where ___ the file?\nhe와 put을 알맞은 어순으로 빈칸에 쓰세요.','he put','의문사절이 know의 목적어이므로 where he put the file이라는 평서문 어순이다. where did he put처럼 도치하지 않는다.'],
 ['“나는 그 가게가 왜 그렇게 일찍 닫는지 모르겠다.”\nI cannot tell why ___ so early.\nthe shop과 close를 알맞은 어순과 형태로 빈칸에 쓰세요.','the shop closes','간접의문문은 의문사 + 주어 + 동사 어순이므로 why the shop closes다. why does the shop close처럼 do를 넣지 않는다.'],
 ['“그 사무실은 토요일에 문을 닫지, 그렇지?”\nThe office is closed on Saturdays, ___?\n부가의문문 두 단어를 쓰세요.','isn\'t it','주절이 be동사 긍정문이므로 부가의문문은 부정형 isn’t it이다. 주어 The office는 대명사 it으로 받는다.'],
 ['“그들은 어제 그 서류를 보냈지, 그렇지?”\nThey sent the documents yesterday, ___?\n부가의문문 두 단어를 쓰세요.','didn\'t they','주절이 일반동사 과거 긍정문이므로 didn’t they다. 조동사가 없으면 do의 알맞은 시제형을 가져온다.'],
 ['“그는 좀처럼 회의에 늦지 않지, 그렇지?”\nHe is rarely late for meetings, ___?\n부가의문문 두 단어를 쓰세요.','is he','rarely는 이미 부정의 뜻을 담은 부사이므로 주절을 부정문으로 보고 긍정형 부가의문문 is he를 쓴다. isn’t he로 쓰지 않는다.'],
 ['“그 아이들은 아직 저녁을 먹지 않았지, 그렇지?”\nThe children have not eaten yet, ___?\n부가의문문 두 단어를 쓰세요.','have they','주절이 부정문이므로 긍정형 have they를 쓴다. 주절의 조동사 have를 그대로 가져온다.']]);
 ...
 judge('question-form',['Could you tell me where he put the spare batteries last night?','The office is closed on Saturdays throughout the winter, isn’t it?','I cannot remember when did the last train leave the station.','They sent the signed documents yesterday morning, didn’t they?'],2,'의문사절이 remember의 목적어이므로 평서문 어순인 when the last train left로 고친다. 첫 문장도 where 뒤가 주어와 동사 순서라 맞다. 둘째와 넷째는 각각 be동사 긍정 주절과 일반동사 과거 긍정 주절에 맞춘 부가의문문이라 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('question-form',['He is rarely late for the morning meetings, is he?','The children have not finished their homework yet, have they?','Nobody knows why does the machine stop every afternoon.','She asked me how much the repair would cost in the end.'],2,'의문사절이 knows의 목적어이므로 평서문 어순인 why the machine stops로 고친다. 첫 문장은 rarely라는 부정어가 있어 긍정형 is he가 맞다. 둘째는 부정 주절이라 긍정형 have they가 맞다. 넷째도 how much 뒤가 주어와 동사 순서라 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
 ...
 ['“그는 실수로 그 메일을 지운 것을 인정했다.”\nHe admitted ___ the email by mistake.\ndelete를 알맞은 형태로 바꿔 한 단어로 쓰세요.','deleting','admit은 동명사를 목적어로 쓴다. admitted to delete가 아니라 admitted deleting이다.'],
 ['“그 정치인은 인터뷰에서 인용되는 것을 피했다.”\nThe politician avoided ___ in the interview.\nquote를 사용해 수동 동명사 두 단어로 쓰세요.','being quoted','avoid는 동명사를 목적어로 쓰고, 인용되는 쪽이 주어이므로 수동형 being quoted가 된다. avoided to be quoted로 쓰지 않는다.'],
 ['“그 회사는 누구와도 자료를 공유한 적이 없다고 부인했다.”\nThe company denied ___ the data with anyone.\nshare를 알맞은 형태로 바꿔 한 단어로 쓰세요.','sharing','deny는 동명사를 목적어로 쓴다. denied to share로 쓰지 않는다.'],
 ['“잠시 저와 자리를 바꿔 주시겠어요?”\nWould you mind ___ seats with me for a moment?\nchange를 알맞은 형태로 바꿔 한 단어로 쓰세요.','changing','mind는 동명사를 목적어로 쓴다. Would you mind to change로 쓰지 않는다.'],
 ['“그 아이들은 텐트에서 자는 것을 즐긴다.”\nThe children enjoy ___ in a tent.\nsleep을 알맞은 형태로 바꿔 한 단어로 쓰세요.','sleeping','enjoy는 동명사를 목적어로 쓴다. enjoy to sleep이라는 형태는 쓰지 않는다.'],
 ['“그들은 정오 전에 무대 칠하기를 끝냈다.”\nThey finished ___ the stage before noon.\npaint를 알맞은 형태로 바꿔 한 단어로 쓰세요.','painting','finish는 동명사를 목적어로 쓴다. finished to paint로 쓰지 않는다.']]);
 ...
 judge('gerund-only',['She admitted breaking the vase while she was dusting it.','He avoided to answer the question about his travel expenses.','Nobody minds waiting a few more minutes for the late bus.','They enjoyed camping beside the lake all through the summer.'],1,'avoid는 동명사를 목적어로 쓰므로 avoided answering the question으로 고친다. 첫 문장의 admit, 셋째의 mind, 넷째의 enjoy도 모두 동명사를 목적어로 쓰므로 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('gerund-only',['The bank postponed opening the branch until early next year.','My brother finished writing his thesis just before midnight.','The driver denied to see the red light at the intersection.','The cat resisted being put into the carrier for the trip.'],2,'deny는 동명사를 목적어로 쓰므로 denied seeing the red light으로 고친다. 첫 문장의 postpone과 둘째의 finish도 동명사를 목적어로 쓰므로 맞다. 넷째는 고양이가 넣어지는 쪽이라 수동 동명사 being put이 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
 ...
 ['“나는 작년에 그 미술관에 갔던 일을 결코 잊지 못할 것이다.”라는 뜻이 되도록 대괄호 부분을 한 단어로 고쳐 쓰세요.\nI will never forget [to visit] that gallery last year.','visiting','이미 다녀온 일을 기억한다는 뜻이므로 forget visiting이다. forget to visit는 아직 가지 않은 일을 잊는다는 뜻이라 last year와 맞지 않다.'],
 ['“나가기 전에 창문 닫는 것을 기억하세요.”라는 뜻이 되도록 대괄호 부분을 두 단어로 고쳐 쓰세요.\nRemember [closing] the windows before you leave.','to close','앞으로 할 일을 기억하라는 뜻이므로 remember to close다. remember closing은 이미 닫았던 일을 기억한다는 뜻이 된다.'],
 ['“나는 그 열쇠를 서랍에 넣어 둔 것을 분명히 기억한다.”라는 뜻이 되도록 대괄호 부분을 한 단어로 고쳐 쓰세요.\nI clearly remember [to put] the key in the drawer.','putting','이미 넣어 둔 일을 기억하는 것이므로 remember putting이다. remember to put은 앞으로 넣어야 할 일을 가리킨다.'],
 ['“귀하의 요청이 거절되었음을 알려 드리게 되어 유감입니다.”라는 뜻이 되도록 대괄호 부분을 두 단어로 고쳐 쓰세요.\nWe regret [informing] you that your request was denied.','to inform','지금 전하려는 소식이 유감이라는 뜻이므로 regret to inform이다. regret informing은 이미 알린 일을 후회한다는 뜻이 된다.'],
 ['“경고를 듣고 나서 그는 담배를 완전히 끊었다.”라는 뜻이 되도록 대괄호 부분을 한 단어로 고쳐 쓰세요.\nAfter the warning he stopped [to smoke] completely.','smoking','피우던 습관을 그만두었다는 뜻이므로 stopped smoking이다. stopped to smoke는 담배를 피우려고 잠시 멈췄다는 뜻이 된다.']]);
 ...
 judge('infinitive-gerund',['I will never forget meeting her on that rainy platform in Busan.','Remember to lock the side gate when you leave this evening.','He stopped to check his phone in the middle of the crosswalk.','She regrets to lend her car to a driver she barely knew.'],3,'이미 차를 빌려준 일을 후회하는 것이므로 regrets lending으로 고친다. regret to do는 지금 전하려는 소식이 유감이라는 뜻이다. 첫 문장은 이미 만난 일을 기억한다는 뜻이라 forget meeting이 맞다. 둘째는 앞으로 할 일이라 remember to lock이 맞다. 셋째는 확인하려고 잠시 멈췄다는 목적이라 stopped to check가 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('infinitive-gerund',['I clearly remember putting the spare key under the big flowerpot.','They stopped serving breakfast at eleven in the morning.','Do not forget to renew your library card before Friday noon.','We regret informing you that the exhibition has been canceled.'],3,'지금 전하려는 소식이 유감이라는 뜻이므로 regret to inform you로 고친다. regret informing은 이미 알린 일을 후회한다는 뜻이라 안내문에 맞지 않다. 첫 문장은 이미 둔 일을 기억한다는 뜻이라 remember putting이 맞다. 둘째는 제공하던 일을 그만두었다는 뜻이라 stopped serving이 맞다. 셋째는 앞으로 할 일이라 forget to renew가 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
 ...
 ['“그 지연의 이유는 아직 설명되지 않았다.”\nThe reason ___ the delay has not been explained.\n빠진 한 단어를 쓰세요.','for','명사 reason은 for로 무엇에 대한 이유인지를 연결한다. the reason of the delay로 쓰지 않는다.'],
 ['“빠른 결정의 필요성이 분명하다.”\nThe need ___ a quick decision is obvious.\n빠진 한 단어를 쓰세요.','for','명사 need도 for로 대상을 연결한다. the need of a quick decision으로 쓰지 않는다. 문장의 본동사는 중심 주어 The need에 맞춘 is다.'],
 ['본동사가 없는 문장입니다. 대괄호 부분을 과거시제 본동사 한 단어로 고쳐 쓰세요.\nThe reason for the cancellation [being] a power failure.','was','분사 being은 문장의 서술어가 되지 못한다. 중심 주어 The reason에 맞춰 정동사 was를 쓴다.'],
 ['본동사가 없는 문장입니다. 대괄호 부분을 현재시제 본동사 한 단어로 고쳐 쓰세요.\nEvery applicant [having] two references on file.','has','분사 having은 문장의 서술어가 되지 못한다. 주어 Every applicant는 단수 취급이므로 정동사 has를 쓴다.']]);
 ...
 judge('finite',['The need for extra staff became clear during the busy season.','The reason for the sudden cancellation was a power failure.','Every applicant having two references on file by next Monday.','The demand for second-hand textbooks grows every single year.'],2,'분사 having은 문장의 서술어가 되지 못하므로 Every applicant has two references on file로 고친다. 첫 문장의 need for, 둘째의 reason for, 넷째의 demand for는 모두 명사 뒤에 for를 두고 각각 became·was·grows라는 본동사를 갖췄으므로 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('finite',['The reason of the long delay was never explained to anyone.','The need for a new bridge was raised at the town meeting.','The answers from the survey were far more detailed this year.','The demand for rooftop solar panels is rising in this region.'],0,'명사 reason은 for로 이유의 대상을 연결하므로 The reason for the long delay로 고친다. 둘째의 need for와 넷째의 demand for도 같은 짝이라 맞다. 셋째는 중심 주어 The answers에 맞춘 본동사 were가 있어 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
 ...
 ['“그녀가 그 보고서를 끝내는 데 두 주가 걸렸다.”\nIt ___ her two weeks to finish the report.\ntake를 과거형 한 단어로 쓰세요.','took','It takes + 사람 + 시간 + to부정사의 과거형이다. 사람을 넣을 때는 her처럼 목적격을 It 다음에 쓴다.'],
 ['“여기서 공항까지 가는 데 한 시간쯤 걸린다.”\n___ takes about an hour to get to the airport.\n빠진 한 단어를 쓰세요.','It','이 구문의 주어 자리에는 가주어 It을 쓴다. 실제 내용은 뒤의 to부정사가 맡는다. There takes로 쓰지 않는다.'],
 ['“그 아이들이 그 퍼즐을 푸는 데 며칠이 걸렸다.”\nIt took ___ several days to solve the puzzle.\nthey를 알맞은 형태로 바꿔 한 단어로 쓰세요.','them','It takes + 사람 + 시간 + to부정사에서 사람 자리에는 목적격이 오므로 them이다. It took they로 쓰지 않는다.'],
 ['“그 지붕을 고치는 데 하루 종일 걸릴 것이다.”\nIt will take a whole day ___ the roof.\nrepair를 to부정사 두 단어로 쓰세요.','to repair','이 구문에서 실제 내용은 to부정사가 맡으므로 to repair다. for repairing처럼 전치사 + 동명사로 바꾸지 않는다.']]);
 ...
 judge('it-takes',['It took her almost two weeks to finish the final report.','It takes about forty minutes to walk around the whole lake.','It took they nearly a month to rebuild the small bridge.','It will take quite a while to sort out all these records.'],2,'It takes + 사람 + 시간 + to부정사에서 사람 자리에는 목적격이 오므로 It took them nearly a month로 고친다. 첫 문장은 her라는 목적격을 썼으므로 맞다. 둘째와 넷째는 사람을 넣지 않고 시간과 to부정사만 쓴 형태라 맞다.','다음 네 문장 중 어법상 옳지 않은 것을 고르세요.');
 judge('it-takes',['It takes two hours to drive from the port to the old harbor town.','There takes about a week to process a passport application.','It took the whole crew three nights to set up the stage.','It will take a whole day to repair the roof of the barn.'],1,'이 구문의 주어 자리에는 가주어 It을 쓰므로 It takes about a week으로 고친다. There is 구문과 섞어 쓰지 않는다. 첫 문장과 넷째는 It + take + 시간 + to부정사를 지켰고, 셋째는 사람을 넣은 It took the whole crew three nights 형태라 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
