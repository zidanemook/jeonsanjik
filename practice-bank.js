...
(function(root){
 ...
 judge('lookalike',['They found the missing map under a pile of old newspapers.','The museum was found in 1912 by a group of local teachers.','The twins are lying on the grass and watching the clouds.','He laid his coat over the back of the chair and sat down.'],1,'박물관을 세웠다는 뜻이므로 found(설립하다)의 과거분사 founded를 써서 was founded로 고친다. was found는 “발견되었다”라는 뜻이라 1912년에 세워졌다는 내용과 맞지 않다. 첫 문장은 find(찾다)의 과거형 found라 맞다. 셋째는 자동사 lie의 -ing형 lying이라 맞다. 넷째는 his coat라는 목적어가 있어 laid가 맞다.','다음 중 어법에 맞지 않는 문장 하나를 고르세요.');
